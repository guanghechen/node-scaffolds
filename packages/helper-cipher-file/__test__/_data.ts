...
export const itemTable: Record<ISymbol, IFileCipherCatalogItem> = {
  ...
  A2: {
    sourceFilepath: 'a.txt',
    encryptedFilepath: 'encrypted/18b7cb099a9ea3f50ba899b5ba81e0d377a5f3b16f8f6eeb8b3e58cd4692b993',
    encryptedFileParts: [],
  ...
  B: {
    ...
    encryptedFilepath: 'encrypted/ffa0da5d885fba09d903c782713b6b098c8cf21f56a3a35d9aa920613220d2e1',
    encryptedFileParts: [],
  ...
  C: {
    ...
    encryptedFilepath: 'encrypted/4fe006196474bf40b078b5e230ccf558f791129837884cbc74daf74ef1164420',

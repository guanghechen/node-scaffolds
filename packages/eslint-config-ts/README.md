<header>
  <h1 align="center">
    <a href="https://github.com/guanghechen/node-scaffolds/tree/@guanghechen/eslint-config-ts@6.0.0-alpha.4/packages/eslint-config-ts#readme">@guanghechen/eslint-config-ts</a>
  </h1>
  <div align="center">
...
[homepage]: https://github.com/guanghechen/node-scaffolds/tree/@guanghechen/eslint-config-ts@6.0.0-alpha.4/packages/eslint-config-ts#readme

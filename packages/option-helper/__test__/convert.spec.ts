...
describe('convert', function () {
  ...
  describe('convertToInteger', function () {
    ...
    test('123132.23 ==> 123132', () => expect(convertToInteger(123132)).toEqual(123132))
    test('-123132.23 ==> -123132', () => expect(convertToInteger(-123132)).toEqual(-123132))
    test("'0' ==> 0", () => expect(convertToInteger('0')).toEqual(0))
    test("'1' ==> 1", () => expect(convertToInteger('1')).toEqual(1))
    test("'-1' ==> -1", () => expect(convertToInteger('-1')).toEqual(-1))
    ...
    test('undefined ==> null', () => expect(convertToInteger(undefined)).toBeNull())
  ...
  describe('convertToNumber', function () {
    ...
    test('123132.23 ==> 123132.23', () => expect(convertToNumber(123132.23)).toEqual(123132.23))
    test('-123132.23 ==> -123132.23', () => expect(convertToNumber(-123132.23)).toEqual(-123132.23))
    test("'0' ==> 0", () => expect(convertToNumber('0')).toEqual(0))
    test("'1' ==> 1", () => expect(convertToNumber('1')).toEqual(1))
    test("'-1' ==> -1", () => expect(convertToNumber('-1')).toEqual(-1))
    ...
    test('undefined ==> null', () => expect(convertToNumber(undefined)).toBeNull())
  ...
  describe('convertToString', function () {
    ...
    test('undefined ==> null', () => expect(convertToString(undefined)).toBeNull())
